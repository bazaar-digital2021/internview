...
export default function RefundPolicy() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        "Refund requests arising from serious emergencies (such as medical emergencies) will be considered on a case-by-case basis. Internview reserves the right to request appropriate supporting documentation and to make the final decision regarding any exception. Where a refund request is approved, the refund will be processed within 14 (fourteen) business days from the date of approval, using the original mode of payment, unless otherwise agreed in writing.",
    },
  ];
          ...
          <Card className="mb-8 shadow-md border-0">
            <CardContent className="p-8">
              <p className="text-lg mb-4">
                At Internview, we are dedicated to providing a high-quality
                learning and professional experience. We value your trust and
                strive to ensure your satisfaction. Please carefully review our
                refund policy below:
              </p>
            </CardContent>
          </Card>
              ...
              <Card className="mb-6 shadow-md border-0 overflow-hidden">
                ...
                >
                  <h2 className="text-xl font-semibold flex items-center">
                    <span
                      className={`w-7 h-7 inline-flex items-center justify-center ${activeSection === index ? "bg-white/20" : "bg-[#1b335f]/10"} rounded-full mr-3 text-sm`}
                    >
                      {index + 1}
                    </span>
                    {section.title}
                  ...
                  <ChevronUp
                    className={`transition-transform ${activeSection === index ? "transform rotate-0" : "transform rotate-180"} w-5 h-5`}
                  />
                </button>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      We recommend reviewing all program details thoroughly
                      before making any payment. If you have questions about
                      your specific situation, please contact our support team
                      for assistance before proceeding with registration.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <Card className="mt-10 shadow-md border-0">
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-[#f0f4ff] rounded-lg">
                ...
                <a
                  href="mailto:support@internview.in"
                  className="text-[#3660a3] hover:underline font-medium"
                >
